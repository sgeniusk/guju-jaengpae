...
## 현재 상태 (2026-06-04) — v0.6 완료 + Codex Ultragoal Phase 7 완료
...
2. **승인 전 안전 작업** — 릴리스 게이트 재검증이나 운영 문서 정리처럼 nation id 확정 없이 가능한 작업을 먼저 고른다.
